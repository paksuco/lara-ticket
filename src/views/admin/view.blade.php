...
<div class="container p-4 text-sm md:p-12">
    <div class="flex flex-col">
        <div class="flex items-center justify-start w-full mb-8">
            <a href="{{ url('/admin/tickets') }}" class="px-3 py-1 mr-3 font-semibold text-white bg-blue-600 rounded hover:text-white hover:bg-blue-700"><i class="fa fa-chevron-left"></i></a>
        ...
        <div class="p-0 rounded">
            ...
            <div class="flex-auto py-2 mb-4">
                ...
                <div class="flex flex-wrap mb-4 rounded">
                    ...
                    <form method="POST" class="w-full p-4 rounded-lg bg-cool-gray-200" action="{{ url('/admin/tickets/comments/store/'.$ticket->id) }}">
                        {{ csrf_field() }}
